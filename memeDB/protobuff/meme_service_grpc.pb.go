...
const (
	MemeService_UploadMeme_FullMethodName = "/meme_service.MemeService/UploadMeme"
)
...
type MemeServiceClient interface {
	...
	UploadMeme(ctx context.Context, in *UploadMemeRequest, opts ...grpc.CallOption) (*UploadMemeResponse, error)
}
...
func (c *memeServiceClient) UploadMeme(ctx context.Context, in *UploadMemeRequest, opts ...grpc.CallOption) (*UploadMemeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UploadMemeResponse)
...
type MemeServiceServer interface {
	// Upload a new meme with tags
	UploadMeme(context.Context, *UploadMemeRequest) (*UploadMemeResponse, error)
...
func (UnimplementedMemeServiceServer) UploadMeme(context.Context, *UploadMemeRequest) (*UploadMemeResponse, error) {
...
var MemeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "meme_service.MemeService",
