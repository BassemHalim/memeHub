...
func TestBadGetMeme(t *testing.T) {
	...
	server, err := newWithMemeService(nil, nil, nil, GetDebugLogger(), nil, MemCache)
	if err != nil {
...
type MockMemeService struct {
	UploadMemeFunc       func(ctx context.Context, in *pb.UploadMemeRequest) (*pb.MemeResponse, error)
	GetMemeFunc          func(ctx context.Context, in *pb.GetMemeRequest) (*pb.MemeResponse, error)
	DeleteMemeFunc       func(ctx context.Context, in *pb.DeleteMemeRequest) (*pb.DeleteMemeResponse, error)
	GetTimelineMemesFunc func(ctx context.Context, in *pb.GetTimelineRequest) (*pb.MemesResponse, error)

	SearchMemesFunc       func(ctx context.Context, in *pb.SearchMemesRequest) (*pb.MemesResponse, error)
	SearchTagsFunc        func(ctx context.Context, in *pb.SearchTagsRequest) (*pb.TagsResponse, error)
	AddTagsFunc           func(ctx context.Context, in *pb.AddTagsRequest) (*pb.AddTagsResponse, error)
	UpdateMemeFunc        func(ctx context.Context, in *pb.UpdateMemeRequest) (*pb.UpdateMemeResponse, error)
	IncrementDownloadFunc func(ctx context.Context, in *pb.IncrementEngagementRequest) (*pb.IncrementEngagementResponse, error)
	IncrementShareFunc    func(ctx context.Context, in *pb.IncrementEngagementRequest) (*pb.IncrementEngagementResponse, error)
	GetPendingMemesFunc   func(ctx context.Context, in *pb.GetPendingMemesRequest) (*pb.MemesResponse, error)
	ApproveMemeFunc       func(ctx context.Context, in *pb.ApproveMemeRequest) (*pb.ApproveMemeResponse, error)
}

func (c *MockMemeService) GetMeme(ctx context.Context, in *pb.GetMemeRequest) (*pb.MemeResponse, error) {
	if c.GetMemeFunc != nil {
		return c.GetMemeFunc(ctx, in)
	}
...
func (m *MockMemeService) UploadMeme(ctx context.Context, in *pb.UploadMemeRequest) (*pb.MemeResponse, error) {
	return m.UploadMemeFunc(ctx, in)
}

func (m *MockMemeService) DeleteMeme(ctx context.Context, in *pb.DeleteMemeRequest) (*pb.DeleteMemeResponse, error) {
	return m.DeleteMemeFunc(ctx, in)
}

func (m *MockMemeService) GetTimelineMemes(ctx context.Context, in *pb.GetTimelineRequest) (*pb.MemesResponse, error) {
	return m.GetTimelineMemesFunc(ctx, in)
}

func (m *MockMemeService) SearchMemes(ctx context.Context, in *pb.SearchMemesRequest) (*pb.MemesResponse, error) {
	return m.SearchMemesFunc(ctx, in)
}

func (m *MockMemeService) SearchTags(ctx context.Context, in *pb.SearchTagsRequest) (*pb.TagsResponse, error) {
	return m.SearchTagsFunc(ctx, in)
}
func (m *MockMemeService) AddTags(ctx context.Context, in *pb.AddTagsRequest) (*pb.AddTagsResponse, error) {
	return m.AddTagsFunc(ctx, in)
}

func (m *MockMemeService) UpdateMeme(ctx context.Context, in *pb.UpdateMemeRequest) (*pb.UpdateMemeResponse, error) {
	return m.UpdateMemeFunc(ctx, in)
}

func (m *MockMemeService) IncrementDownload(ctx context.Context, in *pb.IncrementEngagementRequest) (*pb.IncrementEngagementResponse, error) {
	if m.IncrementDownloadFunc != nil {
		return m.IncrementDownloadFunc(ctx, in)
	}
	return &pb.IncrementEngagementResponse{Success: true}, nil
}

func (m *MockMemeService) IncrementShare(ctx context.Context, in *pb.IncrementEngagementRequest) (*pb.IncrementEngagementResponse, error) {
	if m.IncrementShareFunc != nil {
		return m.IncrementShareFunc(ctx, in)
	}
	return &pb.IncrementEngagementResponse{Success: true}, nil
}

func (m *MockMemeService) GetPendingMemes(ctx context.Context, in *pb.GetPendingMemesRequest) (*pb.MemesResponse, error) {
	if m.GetPendingMemesFunc != nil {
		return m.GetPendingMemesFunc(ctx, in)
	}
	return &pb.MemesResponse{}, nil
}

func (m *MockMemeService) ApproveMeme(ctx context.Context, in *pb.ApproveMemeRequest) (*pb.ApproveMemeResponse, error) {
	if m.ApproveMemeFunc != nil {
		return m.ApproveMemeFunc(ctx, in)
	}
	return &pb.ApproveMemeResponse{Success: true}, nil
}
func TestGetMeme(t *testing.T) {
	client := MockMemeService{}

	server, err := newWithMemeService(&client, nil, nil, GetDebugLogger(), &http.Client{}, MemCache)
	if err != nil {
		t.Fatal("Failed to create server")
	}
...
func TestTrackDownload(t *testing.T) {
	tests := []struct {
		name           string
		memeID         string
		mockFunc       func(ctx context.Context, in *pb.IncrementEngagementRequest) (*pb.IncrementEngagementResponse, error)
		expectedStatus int
	}{
		{
